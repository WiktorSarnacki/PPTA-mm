...
<div id="space"></div>
    ...
    <?php
        ...
        while ($rows = $result->fetch_assoc()){
            ...
            echo "<h1 id='prod_title'>".$rows['prod_name']."</h1>";
            echo "<p id='prod_title'>Cena: ".$rows['price']."zł</p>";
            echo "<p id='prod_desc'>Sprzedwaca: ".$rows['seller']."</p>";
            echo "</div>";
            echo "<form method='post' action='index.php'>";
            echo "<div id='akcje-produktu'><input id='id-prod' type='hidden' name='id-produktu' value=".$rows['id']."><input id='button-koszyk' type='submit' name='addcart' value='Dodaj do koszyka'></div>";
